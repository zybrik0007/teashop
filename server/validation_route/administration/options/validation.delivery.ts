...
/*Проверка запрсов на валидность данных разделе Способ доставки*/
export class DeliveryValidation {

  /*Проверка запроса списка способов доаставки, для главной таблицы*/
  getDelivery(req): [boolean, string] {
