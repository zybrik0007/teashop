...
/*Проверка запрсов на валидность данных разделе Группа пользотвателей*/
export class GroupValidation {

  /*Проверка запроса списка групп пользователей, для главной таблицы*/
  getGroup(req): [boolean, string] {
